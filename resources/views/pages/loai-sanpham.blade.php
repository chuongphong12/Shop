								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('sanpham',$loai->id)}}"><img src="sources/image/product/{{$loai->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$loai->name}}</p>
											<p class="single-item-price">
												@if($loai->promotion_price==0)
													<span class="flash-sale">{{number_format($loai->unit_price)}}</span>
												@else
													<span class="flash-del">{{number_format($loai->unit_price)}}</span>
													<span class="flash-sale">{{number_format($loai->promotion_price)}}</span>
												@endif
											</p>
										</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												@if($loai->promotion_price==0)
													<span class="flash-sale">{{number_format($spk->unit_price)}}</span>
												@else
