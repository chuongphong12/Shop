			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 142 Phạm Phú Thứ, Phường 3, Quận 6</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0122 2714 016</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						@if(Auth::check())
							...
							@else
							<li><a href=""><i class="fa fa-user"></i>Welcome {{Auth::user()->full_name}}</a></li>
							@endif
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Total: <span class="cart-total-value">@if(Session::has('cart')){{number_format($totalPrice)}} @else 0 @endif đồng</span></div>
									<div class="clearfix"></div>
